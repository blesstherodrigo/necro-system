...
municao_bronze = Municao("Bronze", 5,5,5, "Nenhuma")

# Ferro (Melhor contra Infectado | Pior contra Ácido)
municao_ferro = Municao("Ferro", 8,11,10, "Infecção")

# Cobre (Melhor contra Elétrico | Pior contra Infectado)
municao_cobre = Municao("Cobre", 8,11, 10, "Eletricidade")

# Titânio (Melhor contra Ácido | Pior contra Radioativo)
municao_titanio = Municao("Titânio", 8,11, 10, "Acidez")

# Chumbo (Melhor contra Radioativo | Pior contra Elétrico)
municao_chumbo = Municao("Chumbo", 8,11, 10, "Radioatividade")
